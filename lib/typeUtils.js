...
export const getTypeString = val => Object.prototype.toString.call(val)

// 获取原始数据类型 如：array
export const getRawType = val => getTypeString(val).slice(8, -1).toLowerCase()
...
export const isPlainObjectOrArray = val => isPlainObject(val) || Array.isArray(val)