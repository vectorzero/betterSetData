...
export default class BetterSetData {
  updatedData = Object.create(null) // 保存要渲染的数据
  setDataCbQueue = [] // setData 回调队列
  renderedFlag = false // 本轮是否被渲染过标识
  oriSetData // 原生setData方法
  setDataTimeStamp = 0 // setData 开始时间戳
  timeConsuming = 0 // setData 结束耗时
  setDataTimes = 0 // setData 次数
  ...
  // 更新数据
  updateData(path, newVal, oldVal, options) {
    // 收集本轮待更新数据
